...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Cargando Luxfiro Cliente", "author": "Luxfiro Cliente" },
            { "message": "El Launcher esta cargando...", "author": "Luxfiro Cliente" },
            { "message": "Starting Server...", "author": "Luxfiro Cliente" }
        ]
